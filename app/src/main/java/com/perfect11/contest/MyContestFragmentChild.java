...
public class MyContestFragmentChild extends BaseFragment {
    ...
    public static MyContestFragmentChild newInstance() {
        return new MyContestFragmentChild();
    }
    ...
    private void callAPI() {
        ...
        Call<MyContestWrapper> call = apiInterface.getMyContest(userDto.member_id);
