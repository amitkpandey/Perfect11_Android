...
public class StickyListHeadersListView extends FrameLayout {
    ...
    public StickyListHeadersListView(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (attrs != null) {
            ...
            try {
                ...
                mList.getRefreshableView().setCacheColorHint(a.getColor(R.styleable.StickyListHeadersListView_android_cacheColorHint, mList.getRefreshableView().getCacheColorHint()));
                ...
                mList.getRefreshableView().setScrollBarStyle(a.getInt(R.styleable.StickyListHeadersListView_android_scrollbarStyle, 0));
                ...
                mList.getRefreshableView().setStackFromBottom(a.getBoolean(R.styleable.StickyListHeadersListView_android_stackFromBottom, false));
     ...
     */
    public PullToRefreshListView getWrappedList() {
        return mList;
    }
    ...
    public void setStackFromBottom(boolean stackFromBottom) {
        mList.getRefreshableView().setStackFromBottom(stackFromBottom);
    }

    public boolean isStackFromBottom() {
        return mList.getRefreshableView().isStackFromBottom();
    }
}
