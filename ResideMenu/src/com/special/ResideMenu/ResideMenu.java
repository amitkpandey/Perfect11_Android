...
public class ResideMenu extends FrameLayout {
    ...
    private void initViews(Context context, int customLeftMenuId, int customRightMenuId) {
        ...
        if (customLeftMenuId >= 0) {
            ...
            scrollViewLeftMenu = inflater.inflate(R.layout.residemenu_custom_left_scrollview, this, true);
    ...
    private void setMenu(View v) {
        System.out.println("viewActivity " + viewActivity + "view " + v);
        viewActivity.setContent(v);
    }
    ...
    private View getMenu() {
        return viewActivity.getContent();
    }
...
//    }
    ...
    protected boolean fitSystemWindows(Rect insets) {
        ...
        // and returning true. This behavior is off by default and can be enabled through setFitsSystemWindows(boolean) in api14+ devices.
...
//        setMenu(new FrameLayout(activity));
    }
